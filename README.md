<details>
<summary>🇨🇴 🙏 <b>Colombia needs us / Colombia nos necesita</b> ❤️</summary>
...
This module is designed and tested exclusively for the **Pixel Launcher** on official Google Pixel firmware.

Compatible with **Android 17**.

> [!WARNING]
> Its functionality is not guaranteed on custom ROMs (LineageOS, Pixel Experience, etc.) or third-party launchers (Nova, Lawnchair, etc.).

> [!TIP]
> This module requires an installation of Magisk or KernelSU and an Xposed, LSPosed or Vector environment with Zygisk enabled.

---

### 🛡️ Security and Play Protect Warning

Since this application requests special permissions to modify internal system functions via Xposed, it is very common for **Google Play Protect** to flag it as an "Unknown app" or block it when trying to install. This is a standard false positive for root modules outside the Play Store.
...
| Channel | Source |
| :--- | :--- |
| **Stable Versions** | [GitHub Releases](https://github.com/beymans-code/pixel-taskbar-enabler/releases) |
